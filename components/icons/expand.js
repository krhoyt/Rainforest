export default class RFIconExpand extends HTMLElement {
  constructor() {
    super();
...
<path d="M14 14L2.03003 2.02002" class="stroke-linejoin-round"/>
</svg>
...
window.customElements.define( 'rf-icon-expand', RFIconExpand );
