export default class RFIconFaceHappyFilled extends HTMLElement {
  constructor() {
    super();
...
window.customElements.define( 'rf-icon-face-happy-filled', RFIconFaceHappyFilled );
