export default class RFIconFaceNeutral extends HTMLElement {
  constructor() {
    super();
...
<path d="M5 10H11" class="stroke-linejoin-round"/>
</svg>
...
window.customElements.define( 'rf-icon-face-neutral', RFIconFaceNeutral );
