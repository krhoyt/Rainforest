export default class RFIconMultiscreen extends HTMLElement {
  constructor() {
    super();
...
<path class="stroke-linejoin-round" d="M11 3V1.01001L1.01 1L1 8H2.998" />
...
window.customElements.define( 'rf-icon-multiscreen', RFIconMultiscreen );
