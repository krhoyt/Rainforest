export default class RFIconUploadDownload extends HTMLElement {
  constructor() {
    super();
...
<path d="M4 8.99998V1" class="stroke-linejoin-round"/>
...
window.customElements.define( 'rf-icon-upload-download', RFIconUploadDownload );
